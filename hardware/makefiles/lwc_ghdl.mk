...
GHDL_SIM_OPTS2 ?= --mb-comments --ieee=synopsys 

GHDL_IEEE_SYNOPSYS ?= 1
...
GHDL_ANALYSIS_OPTS = -frelaxed-rules --warn-no-vital-generic -frelaxed $(GHDL_OPTIMIZE) --mb-comments \
	$(if $(GHDL_IEEE_SYNOPSYS),--ieee=synopsys,) $(GHDL_STD_OPT)

GHDL_ELAB_OPTS = $(GHDL_STD_OPT) $(if $(GHDL_IEEE_SYNOPSYS),--ieee=synopsys,) --mb-comments
...
sim-ghdl: $(WORK_LIB)-obj$(VHDL_STD).cf config-vars
	...
	$(GHDL_BIN) -r $(GHDL_SIM_OPTS2) $(GHDL_STD_OPT) $(SIM_TOP) $(GHDL_SIM_OPTS) $(GHDL_GENERICS_OPTS)
