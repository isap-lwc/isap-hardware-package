...
if args.all_path:
    for failed_test_vectors_txt in glob('**/*/failed_test_vectors.txt', recursive=True):
        ...
        decoded_pdi = parse_di(kat_dir / 'generated_tv' / 'TV_16' / 'pdi.txt')
        decoded_sdi = parse_di(kat_dir / 'generated_tv' / 'TV_16' / 'sdi.txt')
        expected_do = parse_do(kat_dir / 'generated_tv' / 'TV_16' / 'do.txt')
