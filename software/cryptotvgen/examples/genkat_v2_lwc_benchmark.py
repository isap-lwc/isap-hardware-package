...
dest_folder = "testvectors/v2_lwc_benchmark"
aead_lib_name = 'isapk128av20'  # Library name of AEAD algorithm
# Comment out if not supported
hash_lib_name = 'asconhashv12'  # Library name of hash algorithm
PDI_width = 16 # I/O width: PDI/DO bits
SDI_width = 16 # I/O width: SDI bits
key_size = 128 # bits
npub_size = 128 # bits
nsec_size = 0  # bits
tag_size = 128 # bits
block_size_message  = 144 # bits
block_size_ad = 144 # bits
...
if __name__ == '__main__':
    ...
    args = [
        '--lib_path', str(script_dir.parents[1] / 'isap_ref' / 'lib'),
        '--aead', aead_lib_name,
